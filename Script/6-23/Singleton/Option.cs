...
public class Option : MonoBehaviour
{
    ...
    public void ControllBgm(bool isOn)
    {
        if (!isOn)
        {
            bgm = true;
    ...
    public void ControllSfx(bool isOn)
    {
        if (!isOn)
        {
            sfx = true;
...
public void SensiControll()
    ...
    private void Start()
    {
        MuteBGM.onValueChanged.AddListener(ControllBgm);
        MuteSFX.onValueChanged.AddListener(ControllSfx);
    ...
    private void Update()
    {
        ...
        if(SceneManager.GetActiveScene().name == "GG")
        {
            Cursor.visible = true;
